...
class TranscribeRequest(StrictBaseModel):
...
class QAGenerateRequest(StrictBaseModel):
...
class QAEvaluateRequest(StrictBaseModel):
...
class TTSRequest(StrictBaseModel):
...
class RoadmapRequest(StrictBaseModel):
