  ...
  return (
    ...
    >
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <button className="w-full bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold py-3.5 rounded-2xl transition-all active:scale-[0.98] flex items-center justify-center group gap-2 mt-4">
          Create Account
