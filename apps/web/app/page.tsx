    ...
    <div className="relative text-slate-800">
      ...
      <div className="relative p-6 md:p-8 bg-[#FAFBFC] min-h-[360px] select-none overflow-hidden">
        <div
          ...
          style={{ background: "#5EEAD4", filter: "blur(80px)", opacity: 0.06 }}
        />
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex gap-[3px] h-8 items-center">
                {[55, 80, 45, 100, 60, 85, 40, 75, 50, 90, 65].map((h, i) => (
                  <div
                    ...
                    style={{
                      height: `${h}%`,
                      background: i % 2 ? "#5EEAD4" : "#14B8A6",
                      animation: `full-eq-animate ${0.6 + i * 0.12}s ease-in-out infinite alternate`,
                    }}
                  />
                ))}
              </div>
          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            <div className="rounded-2xl p-5 flex-1 bg-white border border-slate-200 shadow-sm min-h-[140px]">
              <div className="flex items-center gap-2 mb-3">
                <div
                  ...
                  style={{
                    background: recording ? "#14B8A6" : "#D1D5DB",
                    animation: recording
              ...
              {step >= 4 && typedText ? (
                <div>
                  {typedText.split("\n").map((line, i) => (
                    <p
                      key={i}
                      className="text-xs text-slate-600 leading-relaxed mb-1.5 pl-3 border-l-2 transition-all"
                      style={{
                        borderColor:
                          i === typedText.split("\n").length - 1
                            ? "#F59E0B"
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    <span
                      ...
                      style={{
                        background: "#14B8A6",
                        animation: "demo-typing-cursor 0.8s step-end infinite",
                      }}
                    />
            ...
            <div
              className="rounded-2xl p-4 border border-slate-200 shadow-sm"
              ...
              <div className="space-y-2">
                {DEMO_SUMMARY.map((pt, i) => (
                  <div
                    ...
                    style={{
                      opacity: showSummary.includes(i) ? 1 : 0.15,
                      transform: showSummary.includes(i)
                        ? "translateX(0)"
                        : "translateX(-8px)",
                    }}
                  >
                    <CheckCircle2
                      ...
                      style={{
                        color: showSummary.includes(i) ? "#0D9488" : "#D1D5DB",
                      }}
                    />
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M5 2L20 14L12 15.5L8.5 23L5 2Z"
                fill="#1F2937"
                stroke="white"
                strokeWidth="1.5"
          ...
          {showRipple && (
            <div
              className="absolute top-3 left-3 w-8 h-8 rounded-full border-2"
              style={{
                borderColor: "#14B8A6",
...
export default function HomePage() {
  ...
  return (
    <div
      style={{ background: SF.bg }}
      className="min-h-screen text-slate-800 dark:text-slate-100 selection:bg-[#14B8A6]/20 overflow-x-hidden font-sans"
    >
      <Navbar />
      ...
      <section className="relative pt-40 pb-28 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 text-xs font-bold tracking-widest uppercase border"
              style={{
            ...
            <motion.p
              variants={fadeUp}
              className="max-w-2xl mx-auto text-lg text-slate-500 dark:text-slate-400 mb-12 leading-relaxed"
            >
              Record. Transcribe. Summarize. Fren-Edu uses AI to turn every
              lecture, meeting, and seminar into structured notes, interactive
              Q&A, and beautiful mind maps — in seconds.
            </motion.p>
            ...
            >
              {status === "loading" ? (
                <div
                  className="w-44 h-14 rounded-2xl animate-pulse"
                ...
                <>
                  ...
                  <Link
                    href="/record"
                    className="px-8 py-4 rounded-2xl font-bold transition-all border flex items-center gap-2"
                    style={{
                      background: "rgba(20,184,166,0.06)",
                      borderColor: "rgba(20,184,166,0.25)",
                      color: SF.secondary,
          ...
          <motion.div
            ...
            className="mt-20 max-w-2xl mx-auto rounded-3xl p-6 border"
            style={{
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 dark:text-slate-500">
                  Detecting: Bahasa Indonesia · Whisper Large v3
                </p>
              </div>
              <div className="ml-auto flex gap-[3px] h-6 items-end">
                {[100, 60, 80, 45, 90, 55, 70].map((h, i) => (
                  <div
                    ...
                    style={{
                      height: `${h}%`,
                      background: i % 2 ? SF.primary : SF.secondary,
                      animation: `full-eq-animate ${0.8 + i * 0.15}s ease-in-out infinite alternate`,
                    }}
                  />
                ))}
              </div>
            ...
            <p
              className="text-slate-700 dark:text-slate-200 text-sm italic leading-relaxed border-l-2 pl-4"
              style={{ borderColor: SF.primary }}
            >
              "...sehingga perbedaan mendasar antara kedua teori ini terletak
              pada pendekatan mereka terhadap struktur data dan kompleksitas
              algoritmik..."
            </p>
            <div className="flex gap-2 mt-4 flex-wrap">
              {["Ringkasan ✓", "Mind Map ✓", "Q&A ✓", "Ekspor PDF ✓"].map(
                (t) => (
                  <span
                    key={t}
      ...
      <section className="py-8 pb-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            Lihat bagaimana Fren-Edu mengubah suaramu menjadi catatan
          ...
          <motion.div
            ...
            style={{
              boxShadow:
                "0 24px 80px rgba(0,0,0,0.06), 0 4px 24px rgba(0,0,0,0.04)",
            }}
          >
            <InteractiveDemo />
          </motion.div>
      ...
      <section id="features" className="py-24 px-6 relative overflow-hidden">
        <GradientOrb
          className="w-[400px] h-[400px] -right-32 top-0"
          color={SF.primary}
        />
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-xl mx-auto">
              Every feature is designed to reduce friction between learning and
              understanding.
            </p>
          </div>
          <motion.div
          ...
          >
            {FEATURES.map(({ icon: Icon, title, desc, color }) => (
              <motion.div
                ...
                className="p-6 rounded-2xl border cursor-default bg-white shadow-sm hover:shadow-md transition-shadow"
      ...
      >
        <GradientOrb
          className="w-[500px] h-[400px] -left-40 top-10"
          color={SF.secondary}
        />
          ...
          >
            {STEPS.map(({ step, title, desc }, i) => (
              <motion.div
                key={step}
                variants={fadeUp}
                className="relative p-8 rounded-3xl border bg-white shadow-sm hover:shadow-md transition-shadow"
                style={{ borderColor: "var(--border-default)" }}
              >
                <span
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        <GradientOrb
          className="w-[400px] h-[400px] right-0 bottom-0"
          color={SF.accent}
        />
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
          ...
          >
            {TESTIMONIALS.map(({ name, role, text, rating }) => (
              <motion.div
                ...
                variants={fadeUp}
                whileHover={{ y: -4 }}
                className="p-6 rounded-2xl border relative bg-white shadow-sm hover:shadow-md transition-shadow"
                style={{ borderColor: "var(--border-default)" }}
              >
                <Quote
                  className="w-8 h-8 mb-4"
                  style={{ color: SF.primary, opacity: 0.6 }}
                />
            ...
            >
              {[
                ...
                <div
                  key={`${name}-${idx}`}
                  title={name}
                  className="flex items-center opacity-40 hover:opacity-100 hover:scale-110 transition-all duration-300 cursor-pointer"
                >
                  {logo && (
                    <img
                      src={logo}
      ...
      <section id="pricing" className="py-24 px-6 relative overflow-hidden">
        <GradientOrb
          className="w-[600px] h-[400px] left-1/2 -translate-x-1/2 top-0"
          color={SF.primary}
        />
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {PRICING_PLANS.map(
              ({ name, price, period, features, cta, href, highlight }) => (
                <motion.div
                  key={name}
                  initial={{ opacity: 0, y: 24 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className={`p-8 rounded-3xl border flex flex-col bg-white ${highlight ? "md:-translate-y-4 shadow-xl" : "shadow-sm"}`}
                  style={{
                ...
                >
                  ...
                  <Link
                    href={href}
                    className="w-full py-3 rounded-2xl text-center font-bold transition-all text-sm"
                    style={
                      highlight
                        ? {
                            background: SF.secondary,
      ...
      <section className="py-24 px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-4xl mx-auto rounded-[40px] p-16 text-center relative overflow-hidden"
          style={{
        ...
        >
          <GradientOrb
            className="w-[400px] h-[400px] -top-20 left-1/2 -translate-x-1/2"
            color={SF.primary}
          />
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">
                AI-powered learning companion for students and professionals.
              </p>
            </div>
          ...
          >
            <p className="text-xs text-slate-400 dark:text-slate-500">
              © 2026 Fren-Edu. Built with ❤️ for everywhere.
            </p>
