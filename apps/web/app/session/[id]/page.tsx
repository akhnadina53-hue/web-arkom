      ...
      <main className="max-w-5xl mx-auto pt-32 pb-20 px-6">
        ...
        <div className="mb-16">
          <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tighter">
            Physics: Einstein's Core Theories
          </h1>
          <div className="flex gap-4 text-sm font-medium text-slate-500">
            <span className="flex items-center gap-1.5">
              <FileText className="w-4 h-4" /> 1,240 words
            </span>
            <span className="flex items-center gap-1.5">
              <Clock className="w-4 h-4" /> 42 minutes
            </span>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <div className="prose  max-w-none prose-p:text-slate-600 prose-p:leading-relaxed">
                <p>
                  ...
                  implications of time dilation near massive objects...
                </p>
            ...
            >
              ...
              <div className="space-y-6 text-slate-600 font-mono text-sm leading-relaxed">
                ...
                <p>
                  <span className="text-slate-600 mr-4">05:22</span> Imagine a
                  trampoline with a heavy ball in the center. The curve it makes
                  is what gravity is...
                </p>
              </div>
            </motion.section>
          ...
          <div className="space-y-6">
            ...
            <div className="p-8 glass rounded-[32px] bg-teal-500/5 border-teal-500/20">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                You can export this session as a PDF or Markdown for your
                Notability or Obsidian workflow.
              </p>
            </div>
          </div>
        </div>
