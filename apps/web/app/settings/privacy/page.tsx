  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <SettingsGroup title="Visibilitas Profil">
        <SettingsRow
          label="Profil Publik"
          description="Izinkan siapa saja melihat profil kamu, termasuk pengguna yang belum login."
        ...
        >
          <Toggle
            ...
            aria-label="Profile public"
          />
        </SettingsRow>
        <SettingsRow
          label="Tampilkan Institusi"
          description="Tampilkan nama universitas dan jurusan di profil publik."
          htmlFor="show_institution"
        >
          <Toggle
            id="show_institution"
            checked={showInstitution}
            onChange={(v) => {
              setShowInstitution(v);
              mark();
            }}
            aria-label="Show institution"
            disabled={!profilePublic}
          />
        </SettingsRow>
        <SettingsRow
          label="Tampilkan Minat"
          description="Tampilkan tag minat di profil publik."
          htmlFor="show_interests"
        >
          <Toggle
            id="show_interests"
      ...
      <div className="mb-8">
        ...
        <div className="border border-red-500/20 rounded-2xl overflow-hidden bg-red-500/5 divide-y divide-red-500/10">
          ...
          <div className="px-5 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <p className="text-sm font-semibold text-slate-800 dark:text-red-200">
                Hapus Semua Data
              </p>
          ...
          <div className="px-5 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                ...
                Tidak dapat dibatalkan setelah masa tenggang.
              </p>
            </div>
            <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[var(--bg-card)] border border-red-500/30 rounded-2xl p-6 max-w-md w-full shadow-xl">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
              Tindakan ini akan menghapus semua sesi, transkrip, dan file audio.
              Ketik{" "}
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm font-semibold py-2.5 rounded-xl transition-all"
              >
                Batal
              </button>
              <button
      ...
      {showDeleteAccountModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[var(--bg-card)] border border-red-500/30 rounded-2xl p-6 max-w-md w-full shadow-xl">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
              Akun kamu akan{" "}
              <strong className="text-red-500">dihapus permanen</strong> dalam
              30 hari. Ketik{" "}
              <strong className="text-slate-800 dark:text-slate-100">
                DELETE MY ACCOUNT
              </strong>{" "}
